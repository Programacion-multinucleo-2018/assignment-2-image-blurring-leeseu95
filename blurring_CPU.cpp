...
//Tarea 2 - Blurring CPU Version
//g++ -o blurring_CPU blurring_CPU.cpp -lopencv_core -lopencv_highgui -lopencv_imgproc -std=c++11
#include <iostream>
#include <cstdio>
#include <cmath>
#include <chrono>
...
void blurring(cv::Mat& input, cv::Mat& output) //Le pasamos de parametro solo el input , output con CV
{
	...
	for(int i = 0; i < input.rows; i++) {
		for(int j = 0; j < input.cols; j++) { //Iteramos a traves de la matriz
